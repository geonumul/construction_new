...
| 이론 | 역할 |
|:---|:---|
| **Swiss Cheese Model** | 외부감독 변수의 이론적 위치 및 인증×감독 상호작용항(OR=2.130, Model 5-A) 양(+)부호의 선택편향 방어 — Reason (1990, 2000) |
...
| 2 | 계층적 조절효과 분석 (Hierarchical Moderation) | 16모형 A/B 분리: Model 1(5변수)→Model 2(16변수)→Model 3~5 × A/B 분리(14개) + p-value 추적 표 |
| 2+ | LR 타당성 검증 | Hosmer-Lemeshow 검정 — Model 1(5변수): p=0.272, Model 2(16변수): p=0.188, 두 기준 모형 모두 적합 확인 |
...
- **조절효과**: 계층적 조절 Model 3~5에서 인증보유×감독 반복 유의 (OR=1.928~2.165, A그룹 모형) — 인증보유 × 고용노동부감독(OR=2.130, p=0.012, Model 5-A) — Swiss Cheese Model 기반 선택편향으로 해석
